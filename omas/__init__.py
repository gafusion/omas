...
if os.path.exists('/home/ITER/menghio/atom/omas') and '.iter.org' in socket.gethostname() and '/work/imas/opt/EasyBuild/software/OMAS' in os.path.abspath(__file__):
