...
for imas_version in imas_versions:
    ...
    if (
        ...
        or (force_build_json == 'last' and (imas_version == list(imas_versions.keys())[-1]) or imas_version in ['develop/3', 'develop/4'])
    ):
...
for filename in [omas_install_dir + 'README.md', omas_install_dir + 'sphinx/source/index.rst']:
