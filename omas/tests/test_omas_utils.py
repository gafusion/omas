...
class TestOmasUtils(unittest.TestCase):
    ...
    def test_different_ods(self):
        ...
        printv('  diff_prof = {}'.format(diff_prof))
        ...
        printv('  diff_prof2 = {}'.format(diff_prof2))
        ...
        printv('  diff_prof3 = {}'.format(diff_prof3))
        ...
        printv('  diff_prof4 = {}'.format(diff_prof4))
