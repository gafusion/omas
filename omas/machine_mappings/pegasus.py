...
def pegasus_pf_hardware(ods, user_argument='initial Pegasus III model'):
    ...
    fc_dat = np.array(
        [[0.1038085, 0.89506501, 0.0161, 0.021468, 0.0, 0.0, 0, 1.0, 'DIV1A'], #DIV1A - 10 elements
         ...
         [1.00318, 0.05191, 0.00625, 0.10382, 0.0, 0.0, 17, 1.41, 'WALL1'],
         [1.00318, 0.15573, 0.00625, 0.10382, 0.0, 0.0, 17, 1.49, 'WALL1'],
         [1.00318, 0.25955, 0.00625, 0.05191, 0.0, 0.0, 17, 0.83, 'WALL1'],
         [1.00318, 0.31146, 0.00625, 0.05191, 0.0, 0.0, 17, 0.68, 'WALL1'],
         [1.00318, 0.36337, 0.00625, 0.05191, 0.0, 0.0, 17, 0.76, 'WALL1'],
         [1.00318, 0.41528, 0.00625, 0.05191, 0.0, 0.0, 17, 0.87, 'WALL1'],
         [1.00318, 0.46719, 0.00625, 0.05191, 0.0, 0.0, 17, 1.0, 'WALL1'],
         [1.00318, 0.50918001, 0.00625, 0.05191, 0.0, 4.0, 17, 1.1, 'WALL1'],       
         [0.99604702, 0.55118299, 0.00625, 0.0678, 0.0, 9.0, 18, 1.0, 'WALL2'], #WALL COIL PACK 2 - MID UPPER DOME - 7 elements
         [0.96476698, 0.62824702, 0.00625, 0.1, 0.0, 29.0, 18, 1.64, 'WALL2'],
         [0.90642601, 0.70854598, 0.00625, 0.1, 0.0, 43.0, 18, 1.65, 'WALL2'],
         [0.83239502, 0.775204, 0.00625, 0.1, 0.0, 53.0, 18, 1.53, 'WALL2'],
         [0.748945, 0.829916, 0.1, 0.00625, -29.0, 0.0, 18, 1.35, 'WALL2'],
         [0.65957499, 0.87447399, 0.1, 0.00625, -23.0, 0.0, 18, 1.13, 'WALL2'],
         [0.56644601, 0.91069001, 0.1, 0.00625, -19.0, 0.0, 18, 0.90, 'WALL2'],       
         [0.470874, 0.93990898, 0.1, 0.00625, -15.0, 0.0, 19, 1.0, 'WALL3'], #WALL COIL PACK 3 - UPPER UPPER DOME - 10 elements
         [0.37367, 0.96324599, 0.1, 0.00625, -12.0, 0.0, 19, 0.69, 'WALL3'],
         [0.27525, 0.9806, 0.1, 0.00625, 0.0, -8.0, 19, 0.44, 'WALL3'],
         [0.22925, 0.958709, 0.0042, 0.0577, 0.0, 0.0, 19, 0.11, 'WALL3'],
         [0.22925, 0.912121, 0.0042, 0.0577, 0.0, 0.0, 19, 0.12, 'WALL3'],
         [0.22925, 0.86553401, 0.0042, 0.0577, 0.0, 0.0, 19, 0.12, 'WALL3'],
         [0.081428, 0.836, 0.042235, 0.0159, 0.0, 0.0, 19, 0.11, 'WALL3'],
         [0.123663, 0.836, 0.042235, 0.0159, 0.0, 0.0, 19, 0.17, 'WALL3'],
         [0.165898, 0.836, 0.042235, 0.0159, 0.0, 0.0, 19, 0.23, 'WALL3'],
         [0.208133, 0.836, 0.042235, 0.0159, 0.0, 0.0, 19, 0.31, 'WALL3'],   
         [1.0423, -0.2776, 0.0786, 0.006, 0.0, 0.0, 20, 1.0, 'WALL4'], #WALL COIL PACK 4 - OUTER WALL LOWER - 9 elements
         [1.00318, -0.05191, 0.00625, 0.10382, 0.0, 0.0, 20, 1.58, 'WALL4'],
         [1.00318, -0.15573, 0.00625, 0.10382, 0.0, 0.0, 20, 1.59, 'WALL4'],
         [1.00318, -0.25955, 0.00625, 0.05191, 0.0, 0.0, 20, 0.85, 'WALL4'],
         [1.00318, -0.31146, 0.00625, 0.05191, 0.0, 0.0, 20, 0.69, 'WALL4'],
         [1.00318, -0.36337, 0.00625, 0.05191, 0.0, 0.0, 20, 0.77, 'WALL4'],
         [1.00318, -0.41528, 0.00625, 0.05191, 0.0, 0.0, 20, 0.88, 'WALL4'],
         [1.00318, -0.46719, 0.00625, 0.05191, 0.0, 0.0, 20, 1.01, 'WALL4'],
         [1.00318, -0.50918, 0.00625, 0.05191, 0.0, 176.0, 20, 1.12, 'WALL4'],    
         [0.99604702, -0.551183, 0.00625, 0.0678, 0.0, 171.0, 21, 1.0, 'WALL5'], #WALL COIL PACK 5 - MID LOWER DOME - 7 elements
         [0.96476698, -0.628247, 0.00625, 0.1, 0.0, 151.0, 21, 1.65, 'WALL5'],
         [0.90642601, -0.708546, 0.00625, 0.1, 0.0, 137.0, 21, 1.65, 'WALL5'],
         [0.83239502, -0.775204, 0.1, 0.00625, 37.0, 0.0, 21, 1.52, 'WALL5'],
         [0.748945, -0.829916, 0.1, 0.00625, 29.0, 0.0, 21, 1.34, 'WALL5'],
         [0.659575, -0.874474, 0.1, 0.00625, 23.0, 0.0, 21, 1.12, 'WALL5'],
         [0.566446, -0.91069, 0.1, 0.00625, 19.0, 0.0, 21, 0.88, 'WALL5'],
         [0.470874, -0.93990898, 0.1, 0.00625, 15.0, 0.0, 22, 1.0, 'WALL6'], #WALL COIL PACK 6 - LOWER LOWER DOME - 10 elements
         [0.37367, -0.963246, 0.1, 0.00625, 12.0, 0.0, 22, 0.68, 'WALL6'],
         [0.27525, -0.9806, 0.1, 0.00625, 8.0, 0.0, 22, 0.42, 'WALL6'],
         [0.22925, -0.958709, 0.0042, 0.0577, 0.0, 0.0, 22, 0.11, 'WALL6'],
         [0.22925, -0.912121, 0.0042, 0.035475, 0.0, 0.0, 22, 0.07, 'WALL6'],
         [0.22925, -0.865534, 0.0042, 0.0577, 0.0, 0.0, 22, 0.12, 'WALL6'],
         [0.081428, -0.836, 0.042235, 0.0159, 0.0, 0.0, 22, 0.10, 'WALL6'],
         [0.123663, -0.836, 0.042235, 0.0159, 0.0, 0.0, 22, 0.16, 'WALL6'],
         [0.165898, -0.836, 0.042235, 0.0159, 0.0, 0.0, 22, 0.23, 'WALL6'],
         [0.208133, -0.836, 0.042235, 0.0159, 0.0, 0.0, 22, 0.31, 'WALL6'],               
         [0.0603, 0.8, 0.002, 0.1, 0.0, 0.0, 23, 1.0, 'WALL7'], #WALL COIL PACK 7 - CENTER COLUMN & BELLOWS - 17 elements
         [0.0603, 0.7, 0.002, 0.1, 0.0, 0.0, 23, 1.18, 'WALL7'],
         [0.0603, 0.6, 0.002, 0.1, 0.0, 0.0, 23, 1.23, 'WALL7'],
         [0.0603, 0.5, 0.002, 0.1, 0.0, 0.0, 23, 1.22, 'WALL7'],
         [0.0603, 0.4, 0.002, 0.1, 0.0, 0.0, 23, 1.17, 'WALL7'],
         [0.0603, 0.3, 0.002, 0.1, 0.0, 0.0, 23, 1.11, 'WALL7'],
         [0.0603, 0.2, 0.002, 0.1, 0.0, 0.0, 23, 1.05, 'WALL7'],
         [0.0603, 0.1, 0.002, 0.1, 0.0, 0.0, 23, 1.01, 'WALL7'],
         [0.0603, 0.0, 0.002, 0.1, 0.0, 0.0, 23, 0.98, 'WALL7'],
         [0.0603, -0.1, 0.002, 0.1, 0.0, 0.0, 23, 0.98, 'WALL7'],
         [0.0603, -0.2, 0.002, 0.1, 0.0, 0.0, 23, 1.0, 'WALL7'],
         [0.0603, -0.3, 0.002, 0.1, 0.0, 0.0, 23, 1.03, 'WALL7'],
         [0.0603, -0.4, 0.002, 0.1, 0.0, 0.0, 23, 1.06, 'WALL7'],
         [0.0603, -0.5, 0.002, 0.1, 0.0, 0.0, 23, 1.09, 'WALL7'],
         [0.0603, -0.6, 0.002, 0.1, 0.0, 0.0, 23, 1.08, 'WALL7'],
         [0.0603, -0.7, 0.002, 0.1, 0.0, 0.0, 23, 1.02, 'WALL7'],
         [0.0603, -0.8, 0.002, 0.1, 0.0, 0.0, 23, 0.82, 'WALL7'],
         [0.227, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 1.0, 'WALLT1'], # Torque plate #1 - 8 elements
         [0.295, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 1.39, 'WALLT1'],
         [0.363, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 1.90, 'WALLT1'],
         [0.432, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 2.53, 'WALLT1'],
         [0.500, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 3.32, 'WALLT1'],
         [0.568, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 4.30, 'WALLT1'],
         [0.637, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 5.38, 'WALLT1'],
         [0.705, 1.14, 0.068, 0.013, 0.0, 0.0, 24, 6.59, 'WALLT1'],
         [0.227, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 1.0, 'WALLT2'], # Torque plate #2 - 8 elements
         [0.295, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 1.41, 'WALLT2'],
         [0.363, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 1.98, 'WALLT2'],
         [0.432, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 2.73, 'WALLT2'],
         [0.500, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 3.69, 'WALLT2'],
         [0.568, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 4.89, 'WALLT2'],
         [0.637, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 6.35, 'WALLT2'],
         [0.705, -1.14, 0.068, 0.013, 0.0, 0.0, 25, 8.06, 'WALLT2'],
         [0.227, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 1.0, 'WALLT3'], # Torque plate #3 - 8 elements
         [0.295, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 1.35, 'WALLT3'],
         [0.363, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 1.79, 'WALLT3'],
         [0.432, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 2.33, 'WALLT3'],
         [0.500, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 2.98, 'WALLT3'],
         [0.568, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 3.73, 'WALLT3'],
         [0.637, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 4.57, 'WALLT3'],
         [0.705, 1.44, 0.068, 0.013, 0.0, 0.0, 26, 5.42, 'WALLT3'],
         [0.227, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 1.0, 'WALLT4'], # Torque plate #4 - 8 elements
         [0.295, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 1.36, 'WALLT4'],
         [0.363, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 1.83, 'WALLT4'],
         [0.432, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 2.43, 'WALLT4'],
         [0.500, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 3.17, 'WALLT4'],
         [0.568, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 4.07, 'WALLT4'],
         [0.637, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 5.11, 'WALLT4'],
         [0.705, -1.44, 0.068, 0.013, 0.0, 0.0, 27, 6.22, 'WALLT4'],]
         )
    ...
    for coil in fc_dat:
        ...
        if (float(coil[4])==0.0 and float(coil[5])==0.0): #rectangular coil geometry
            ...
            ods['pf_active']['coil'][coil[6]]['element'][count]['geometry.oblique.beta'] = (float(coil[5])-90.0)
        count+=1
