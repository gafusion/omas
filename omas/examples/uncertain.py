...
save_omas_imas(ods, user=os.environ['USER'],machine='test', pulse=10, run=1, new=True)
ods = load_omas_imas(user=os.environ['USER'],machine='test', pulse=10, run=1, verbose=False)
print(ods)
