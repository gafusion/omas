...
def strict_json_dumper(obj):
    """
    Dump objects to strict json format
...
def strict_json_loader(object_pairs, cls=dict):
    """
    Load json-objects generated by the strict_json_dumper function
